export const FETCH_NEWS_REQUEST = 'employee/news/FETCH_NEWS_REQUEST';
export const FETCH_NEWS_SUCCESS = 'employee/news/FETCH_NEWS_SUCCESS';
export const FETCH_NEWS_FAILURE = 'employee/news/FETCH_NEWS_FAILURE';
